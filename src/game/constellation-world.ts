...
function relicShatterVeil() {
  const g = new THREE.Group();
  const pad = new THREE.Mesh(new THREE.CylinderGeometry(0.7, 0.82, 0.24, 8), toon(0x3a2a20, 0x1a1008, 0.08));
  pad.position.y = 0.12;
  g.add(pad);
  const body = new THREE.Mesh(new THREE.BoxGeometry(0.55, 1.15, 0.38), toon(0xd4b46a, 0x8a6018, 0.28));
  body.position.y = 0.85;
  g.add(body);
  const blade = new THREE.Mesh(new THREE.BoxGeometry(0.12, 1.35, 0.08), toon(0x7ee8f2, 0x2aa0c0, 0.7));
  blade.position.set(0.42, 1.35, 0);
  g.add(blade);
  const skull = new THREE.Mesh(new THREE.SphereGeometry(0.22, 8, 6), toon(0xf2ece4, 0xd4c8b8, 0.12));
  skull.position.set(0, 1.58, 0.06);
  g.add(skull);
  const snout = new THREE.Mesh(new THREE.BoxGeometry(0.14, 0.1, 0.22), toon(0xf2ece4, 0xd4c8b8, 0.1));
  snout.position.set(0, 1.5, 0.22);
  g.add(snout);
  for (const sx of [-1, 1]) {
    const ear = new THREE.Mesh(new THREE.ConeGeometry(0.07, 0.22, 4), toon(0xf2ece4, 0xd4c8b8, 0.1));
    ear.position.set(sx * 0.14, 1.78, -0.02);
    ear.rotation.z = sx * -0.2;
    g.add(ear);
  }
  const crystal = new THREE.Mesh(new THREE.OctahedronGeometry(0.16, 0), toon(0x7ee8f2, 0x2aa0c0, 0.7));
  crystal.position.set(0, 1.05, 0.22);
  g.add(crystal);
  return g;
}
...
function relicHowlSight() {
  ...
  pad.position.y = 0.12;
  g.add(pad);
  const body = new THREE.Mesh(new THREE.BoxGeometry(0.42, 0.22, 1.15), toon(0xd4b46a, 0x8a6018, 0.32));
  body.position.set(0, 1.05, 0);
  g.add(body);
  const barrel = new THREE.Mesh(new THREE.CylinderGeometry(0.06, 0.08, 0.9, 8), toon(0xd4b46a, 0x8a6018, 0.28));
  barrel.rotation.x = Math.PI / 2;
  barrel.position.set(0, 1.08, -0.85);
  g.add(barrel);
  const core = new THREE.Mesh(new THREE.OctahedronGeometry(0.16, 0), toon(0x7ee8f2, 0x2aa0c0, 0.7));
  core.position.set(0, 1.22, -0.2);
  g.add(core);
  const skull = new THREE.Mesh(new THREE.SphereGeometry(0.2, 8, 6), toon(0xf2ece4, 0xd4c8b8, 0.12));
  skull.position.set(0, 1.55, 0.42);
  g.add(skull);
  const snout = new THREE.Mesh(new THREE.BoxGeometry(0.12, 0.09, 0.2), toon(0xf2ece4, 0xd4c8b8, 0.1));
  snout.position.set(0, 1.48, 0.58);
  g.add(snout);
  for (const sx of [-1, 1]) {
    const ear = new THREE.Mesh(new THREE.ConeGeometry(0.06, 0.2, 4), toon(0xf2ece4, 0xd4c8b8, 0.1));
    ear.position.set(sx * 0.12, 1.74, 0.36);
    ear.rotation.z = sx * -0.2;
    g.add(ear);
  }
  return g;
...
function buildRelic(id: ArtifactId) {
  switch (id) {
    ...
    case "shatter-veil":
      return relicShatterVeil();
    case "howl-sight":
      return relicHowlSight();
  }
}
