...
export const HUB = {
  title: "Core Spire",
  tag: "The Howling Crucible. Not a throne.",
  radius: 14,
  holdSec: 1.15,
};

export const LORE = {
  arrival: "The Howling Crucible. Howl. Knock the Door. Crystal from leftover Charge.",
  empty: "No wards yet. Charge is tended, never bottled.",
  howl: "Howl is civic gather, not volume. The gather does not close.",
  hubProx: "The first raising waits. Veyra keeps the breath — not a throne.",
  description:
