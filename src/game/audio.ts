...
export function createAudio(): AudioBus {
  ...
  return {
    ...
    shot() {
      play((c) => {
        voice(c, { freq: 240, to: 70, dur: 0.12, type: "square", gain: 0.07, attack: 0.004 });
        voice(c, { freq: 880, to: 220, dur: 0.08, type: "sawtooth", gain: 0.03, attack: 0.002, delay: 0.01 });
      });
      buzz("talk");
    },
    hit() {
      play((c) => {
        voice(c, { freq: 1244, to: 880, dur: 0.07, type: "square", gain: 0.04, attack: 0.002 });
      });
    },
    empty() {
      play((c) => {
        voice(c, { freq: 140, to: 90, dur: 0.08, type: "square", gain: 0.03, attack: 0.002 });
      });
    },
    reload() {
      play((c) => {
        voice(c, { freq: 180, to: 320, dur: 0.16, type: "triangle", gain: 0.04, attack: 0.01 });
        voice(c, { freq: 90, to: 70, dur: 0.22, type: "sine", gain: 0.03, attack: 0.02, delay: 0.12 });
      });
    },
    hurt() {
      play((c) => {
        voice(c, { freq: 90, to: 40, dur: 0.22, type: "sawtooth", gain: 0.06, attack: 0.01 });
      });
      buzz("howl");
    },
    setMuted(m) {
