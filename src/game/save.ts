...
export function loadSave(): SaveData {
  ...
  try {
    ...
    return {
      ...
      px: Number.isFinite(Number(parsed.px)) ? Math.max(-2400, Math.min(2400, Number(parsed.px))) : 9,
      pz: Number.isFinite(Number(parsed.pz)) ? Math.max(-2400, Math.min(2400, Number(parsed.pz))) : 16,
  ...
  try {
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        px: Number.isFinite(Number(data.px)) ? Math.max(-2400, Math.min(2400, Number(data.px))) : 9,
        pz: Number.isFinite(Number(data.pz)) ? Math.max(-2400, Math.min(2400, Number(data.pz))) : 16,
